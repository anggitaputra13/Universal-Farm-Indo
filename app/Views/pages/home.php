            ...
            <div class="row">
                <div class="col-lg-3 col-xs-12">
                    <div class="text-center">
                        <i class="fa fa-heart-o fa-3x" aria-hidden="true" style="align-items:center; margin: 0 auto;"></i>
                    </div>
                    <br>
                ...
                <div class="col-lg-3 col-xs-12">
                    <div class="text-center">
                        <i class="fa fa-tasks fa-3x" aria-hidden="true" style="align-items:center; margin: 0 auto;"></i>
                    </div>
                    <br>
                ...
                <div class="col-lg-3 col-xs-12">
                    <div class="text-center">
                        <i class="fa fa-bell-o fa-3x" aria-hidden="true" style="align-items:center; margin: 0 auto;"></i>
                    </div>
                    <br>
                    <h2 style="text-align: center;">Commitment</h2>
                ...
                <div class="col-lg-3 col-xs-12">
                    <div class="text-center">
                        <i class="fa fa-comment-o fa-3x" aria-hidden="true" style="align-items:center; margin: 0 auto;"></i>
                    </div>
                    <br>
